...
small_cylin_r = [0.003, 0.006, 0.009, 0.012, 0.015]
...
for idx, c_r in enumerate(small_cylin_r):
    stfile = open(base_dir+"/output/granny_pull/" + model_name + "_pull_sr" + str(c_r)+"/" + "stretch_rod.txt", 'r')
    stretch_1 = []
    stretch_2 = []
...
plt.plot(nondim_r, nondim_force, 'bs-')
plt.tight_layout()
