...
if __name__ == "__main__":
    ...
    sim.output_folder = base_dir + "/output/square_pull/" + model_name + '_sr' + str(small_shell_r) + '/' #  + os.path.splitext(os.path.basename(sys.argv[0]))[0] + "/"
    ...
    sim.add_shell_with_scale_3D(base_dir+"/input/cylinder_v363.obj", Vector3d(cylin_move[0]-0.015, cylin_move[1]+0.01, cylin_move[2]), Vector3d(cylin_scale[0], cylin_scale[1], cylin_scale[2]), \
    ...
    sim.add_shell_with_scale_3D(base_dir+"/input/cylinder_v363.obj", Vector3d(cylin_move[0]-0.01, cylin_move[1]+0.01-0.0459, cylin_move[2]), Vector3d(scale_small*cylin_scale[0], scale_small*cylin_scale[1], cylin_scale[2]), \
        Vector3d(0.0, 0.0, 0), Vector3d(1, 0, 0), 0)
    # v, rotCenter, rotAxis, angVelDeg
    sim.set_DBC(Vector3d(-0.1, -0.1, -0.1), Vector3d(1.1, 1.1, 1.1), 
        Vector3d(0, 0, 0), Vector3d(0, 0, 0), Vector3d(0, 0, 0), 0)
